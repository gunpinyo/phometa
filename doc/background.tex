...
\end{framed}
    \caption{This diagram explains that why $((3 + 4) + 5)$ is a term of \texttt{<Expr>}}
...
\end{framed}
    \caption{This diagram explains that why $(12 + (0 \times 6))$ is a term of \texttt{<Expr>}}
...
\Tree[.{$(5 + 7) = 12$ is \texttt{<Equation>} ($1^{st}$ choice)}
      ...
      {$2$ is \texttt{<Digit>}} ] ] ]
\end{framed}
    \caption{This diagram explains that why $(5 + 7) = 12$ is a term of \texttt{<Equation>}}
