...
\node{
  \kRule \pstr{double-negation} \kInference
}{
  \kConclude & \bat{
      \pvar{$\Gamma$}
        \pifmt{$\vdash$}
        ...
        \ban{
            ...
            \ban{
                ...
                \ban{
                    ...
                    \ban{
                        \kProof \bat{
                           \bas{\bat{\pifmt{$\neg$} \bat{\pvar{A} \pifmt{$\vee$} \bat{\pifmt{$\neg$} \pvar{A}}}} \psfmt{,} \bat{\pvar{A}}} \pifmt{$\vdash$}
                           \bat{
                                \pifmt{$\bot$}
                           }
                        } \pgmr{judgement} \\
                        ...
                        \ban{
                          ...
                          % \kProof \bat{
                          %   \bas{\bat{\pifmt{$\neg$} \bat{\pvar{A} \pifmt{$\vee$} \bat{\pifmt{$\neg$} \pvar{A}}}} \psfmt{,} \bat{\pvar{A}}} \pifmt{$\vdash$}
                          %   \bat{\ipfmt{$neg$} \bat{\pvar{A} \pifmt{$\vee$} \bat{\pifmt{$\neg$} \pvar{A}}}}
                          % } \pgmr{judgement} \\
                          % \kUseRule \prule{hyp} \\
...
\subsection{Module \bat{\ppkgmod{example} \ppkgmod{propositional\_logic} \ppkgmod{operational\_semantics}}}

\node{
    \kOpen \bat{\ppkgmod{example} \ppkgmod{propositional\_logic} \ppkgmod{grammar}} \kHideByDefault
} {
    \kShow & \pid{prop} \\
    \kShow & \pid{atom} \\
}
